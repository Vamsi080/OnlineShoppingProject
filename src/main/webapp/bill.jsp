...
try{
	...
	ResultSet rs1 = st.executeQuery("select * from users inner join cart where users.email='"+email+"'and cart.status='bill'");
	while(rs1.next())
{
%>
...
<div class="right-div"><h3>Mobile Number: <%=rs1.getLong(20) %> </h3></div>
<div class="left-div"><h3>Order Date: <%=rs1.getString(21) %> </h3></div>
<div class="right-div-right"><h3>Payment Method: <%=rs1.getString(23) %> </h3></div><br>
